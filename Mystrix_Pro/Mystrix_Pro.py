...
class Mystrix_Pro(ControlSurface):   # Make sure you update the name
    __doc__ = " Script for Mystrix_Pro in APC emulation mode "   # Make sure you update the name
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in Mystrix_Pro._active_instances:   # Make sure you update the name
    ...
    def _do_combine(self):
        if self not in Mystrix_Pro._active_instances:    # Make sure you update the name
            Mystrix_Pro._active_instances.append(self)   # Make sure you update the name
            Mystrix_Pro._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        if (self in Mystrix_Pro._active_instances) and Mystrix_Pro._active_instances.remove(self):    # Make sure you update the name
