...
SESSIONLEFT = 35 # Session left
SESSIONRIGHT = 36  # Session right
SESSIONUP = 33 # Session up
SESSIONDOWN = 34  # Session down
...
# Track Navigation
TRACKLEFT = 37  # Track left
TRACKRIGHT = 38 # Track right

# Scene Navigation
SCENEUP = 48  # Scene down
SCENEDN = 47  # Scene up

# Scene Launch
SELSCENELAUNCH = 49 # Selected scene launch
...
CLIPNOTEMAP = ((1, 2, 3, 4, 5, 6, 7, 8),  # Row 1
...
TRACKSTOP = (39,  # Track 1 Clip Stop
             40,  # Track 2
             41,  # Track 3
             42,  # Track 4
             43,  # Track 5
